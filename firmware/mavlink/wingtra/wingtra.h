/** @file
 *  @brief MAVLink comm protocol generated from wingtra.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_WINGTRA_H
#define MAVLINK_WINGTRA_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_WINGTRA.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#define MAVLINK_MESSAGE_CRCS {{0, 50, 9, 0, 0, 0}, {1, 124, 31, 0, 0, 0}, {2, 137, 12, 0, 0, 0}, {4, 237, 14, 3, 12, 13}, {5, 217, 28, 1, 0, 0}, {6, 104, 3, 0, 0, 0}, {7, 119, 32, 0, 0, 0}, {11, 89, 6, 1, 4, 0}, {20, 214, 20, 3, 2, 3}, {21, 159, 2, 3, 0, 1}, {22, 220, 25, 0, 0, 0}, {23, 168, 23, 3, 4, 5}, {24, 24, 30, 0, 0, 0}, {25, 23, 101, 0, 0, 0}, {26, 170, 22, 0, 0, 0}, {27, 144, 26, 0, 0, 0}, {28, 67, 16, 0, 0, 0}, {29, 115, 14, 0, 0, 0}, {30, 39, 28, 0, 0, 0}, {31, 246, 32, 0, 0, 0}, {32, 185, 28, 0, 0, 0}, {33, 104, 28, 0, 0, 0}, {34, 237, 22, 0, 0, 0}, {35, 244, 22, 0, 0, 0}, {36, 222, 21, 0, 0, 0}, {37, 212, 6, 3, 4, 5}, {38, 9, 6, 3, 4, 5}, {39, 254, 37, 3, 32, 33}, {40, 230, 4, 3, 2, 3}, {41, 28, 4, 3, 2, 3}, {42, 28, 2, 0, 0, 0}, {43, 148, 3, 3, 0, 1}, {44, 205, 6, 3, 4, 5}, {45, 232, 2, 3, 0, 1}, {46, 11, 2, 0, 0, 0}, {47, 153, 3, 3, 0, 1}, {48, 41, 13, 1, 12, 0}, {49, 39, 12, 0, 0, 0}, {50, 78, 37, 3, 18, 19}, {51, 196, 4, 3, 2, 3}, {52, 73, 2, 3, 0, 1}, {54, 15, 27, 3, 24, 25}, {55, 3, 25, 0, 0, 0}, {61, 167, 72, 0, 0, 0}, {62, 183, 26, 0, 0, 0}, {63, 119, 181, 0, 0, 0}, {64, 191, 225, 0, 0, 0}, {65, 118, 42, 0, 0, 0}, {66, 148, 6, 3, 2, 3}, {67, 21, 4, 0, 0, 0}, {69, 243, 11, 0, 0, 0}, {70, 124, 18, 3, 16, 17}, {73, 38, 37, 3, 32, 33}, {74, 20, 20, 0, 0, 0}, {75, 158, 35, 3, 30, 31}, {76, 152, 33, 3, 30, 31}, {77, 143, 3, 0, 0, 0}, {81, 106, 22, 0, 0, 0}, {82, 49, 39, 3, 36, 37}, {83, 22, 37, 0, 0, 0}, {84, 143, 53, 3, 50, 51}, {85, 140, 51, 0, 0, 0}, {86, 5, 53, 3, 50, 51}, {87, 150, 51, 0, 0, 0}, {89, 231, 28, 0, 0, 0}, {90, 183, 56, 0, 0, 0}, {91, 63, 42, 0, 0, 0}, {92, 54, 33, 0, 0, 0}, {93, 47, 81, 0, 0, 0}, {100, 175, 26, 0, 0, 0}, {101, 102, 32, 0, 0, 0}, {102, 158, 32, 0, 0, 0}, {103, 208, 20, 0, 0, 0}, {104, 56, 32, 0, 0, 0}, {105, 93, 62, 0, 0, 0}, {106, 138, 44, 0, 0, 0}, {107, 108, 64, 0, 0, 0}, {108, 32, 84, 0, 0, 0}, {109, 185, 9, 0, 0, 0}, {110, 84, 254, 3, 1, 2}, {111, 34, 16, 0, 0, 0}, {112, 174, 12, 0, 0, 0}, {113, 124, 36, 0, 0, 0}, {114, 237, 44, 0, 0, 0}, {115, 4, 64, 0, 0, 0}, {116, 76, 22, 0, 0, 0}, {117, 128, 6, 3, 4, 5}, {118, 56, 14, 0, 0, 0}, {119, 116, 12, 3, 10, 11}, {120, 134, 97, 0, 0, 0}, {121, 237, 2, 3, 0, 1}, {122, 203, 2, 3, 0, 1}, {123, 250, 113, 3, 0, 1}, {124, 87, 35, 0, 0, 0}, {125, 203, 6, 0, 0, 0}, {126, 220, 79, 0, 0, 0}, {127, 25, 35, 0, 0, 0}, {128, 226, 35, 0, 0, 0}, {129, 46, 22, 0, 0, 0}, {130, 29, 13, 0, 0, 0}, {131, 223, 255, 0, 0, 0}, {132, 85, 14, 0, 0, 0}, {133, 6, 18, 0, 0, 0}, {134, 229, 43, 0, 0, 0}, {135, 203, 8, 0, 0, 0}, {136, 1, 22, 0, 0, 0}, {137, 195, 14, 0, 0, 0}, {138, 109, 36, 0, 0, 0}, {139, 168, 43, 3, 41, 42}, {140, 181, 41, 0, 0, 0}, {141, 47, 32, 0, 0, 0}, {142, 72, 243, 0, 0, 0}, {143, 131, 14, 0, 0, 0}, {144, 127, 93, 0, 0, 0}, {146, 103, 100, 0, 0, 0}, {147, 154, 36, 0, 0, 0}, {148, 178, 60, 0, 0, 0}, {149, 200, 30, 0, 0, 0}, {202, 173, 16, 0, 0, 0}, {203, 180, 33, 0, 0, 0}, {204, 211, 1, 0, 0, 0}, {205, 46, 44, 3, 42, 43}, {206, 181, 4, 3, 2, 3}, {207, 51, 2, 3, 0, 1}, {208, 110, 6, 3, 4, 5}, {209, 255, 2, 3, 0, 1}, {210, 99, 3, 3, 0, 1}, {211, 5, 2, 3, 0, 1}, {222, 131, 1, 0, 0, 0}, {230, 163, 42, 0, 0, 0}, {231, 105, 40, 0, 0, 0}, {232, 151, 63, 0, 0, 0}, {233, 35, 182, 0, 0, 0}, {234, 150, 40, 0, 0, 0}, {240, 138, 201, 0, 0, 0}, {241, 90, 32, 0, 0, 0}, {242, 104, 52, 0, 0, 0}, {243, 85, 53, 1, 52, 0}, {244, 95, 6, 0, 0, 0}, {245, 130, 2, 0, 0, 0}, {246, 184, 38, 0, 0, 0}, {247, 81, 19, 0, 0, 0}, {248, 8, 254, 3, 3, 4}, {249, 204, 36, 0, 0, 0}, {250, 49, 30, 0, 0, 0}, {251, 170, 18, 0, 0, 0}, {252, 44, 18, 0, 0, 0}, {253, 83, 51, 0, 0, 0}, {254, 46, 9, 0, 0, 0}, {256, 71, 42, 3, 8, 9}, {257, 131, 9, 0, 0, 0}, {258, 187, 32, 3, 0, 1}, {259, 122, 86, 0, 0, 0}, {260, 8, 28, 0, 0, 0}, {261, 244, 26, 0, 0, 0}, {262, 141, 23, 0, 0, 0}, {263, 43, 255, 0, 0, 0}, {264, 49, 28, 0, 0, 0}, {265, 26, 16, 0, 0, 0}, {266, 193, 255, 3, 2, 3}, {267, 35, 255, 3, 2, 3}, {268, 14, 4, 3, 2, 3}}
#endif

#include "protocol.h"

#define MAVLINK_ENABLED_WINGTRA

// ENUM DEFINITIONS


/** @brief WINGTRA: result in a mavlink tag ack */
#ifndef HAVE_ENUM_MAV_GEOTAG_RESULT
#define HAVE_ENUM_MAV_GEOTAG_RESULT
typedef enum MAV_GEOTAG_RESULT
{
   MAV_GEOTAG_ACCEPTED=0, /* tags accepted OK | */
   MAV_GEOTAG_ERROR=1, /* generic error / not accepting tags at all right now | */
   MAV_GEOTAG_UNSUPPORTED=3, /* command is not supported | */
   MAV_GEOTAG_NO_SPACE=4, /* tag item exceeds storage space | */
   MAV_GEOTAG_INVALID=5, /* one of the parameters has an invalid value | */
   MAV_GEOTAG_INVALID_LAT=6, /* latitude has an invalid value | */
   MAV_GEOTAG_INVALID_LON=7, /* longitude has an invalid value | */
   MAV_GEOTAG_INVALID_ALT=8, /* altitude has an invalid value | */
   MAV_GEOTAG_INVALID_TIME=9, /* time has an invalid value | */
   MAV_GEOTAG_INVALID_ATTITUDE=10, /* attitude has an invalid value | */
   MAV_GEOTAG_INVALID_SEQUENCE=13, /* received tag out of sequence | */
   MAV_GEOTAG_DENIED=14, /* not accepting any tags from this communication partner | */
   MAV_GEOTAG_CANCELLED=15, /* stop transmission | */
   MAV_GEOTAG_RESULT_ENUM_END=16, /*  | */
} MAV_GEOTAG_RESULT;
#endif

/** @brief WINGTRA: result in a mavlink pfc ack */
#ifndef HAVE_ENUM_MAV_PFC_ACK
#define HAVE_ENUM_MAV_PFC_ACK
typedef enum MAV_PFC_ACK
{
   MAV_ARMING_ACCEPTED=0, /* arming confirmation sent from WP accepted by FS | */
   MAV_AIRSPEED_CAL=1, /* Airspeed calibration failure messsage reached WP | */
   MAV_PFC_ACK_ENUM_END=2, /*  | */
} MAV_PFC_ACK;
#endif
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_SAVE_FACTORY=31100, /* Save current parameters to factory parameter file |Empty| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ENUM_END=31101, /*  | */
} MAV_CMD;
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_geotag_item.h"
#include "./mavlink_msg_geotag_request.h"
#include "./mavlink_msg_geotag_request_count.h"
#include "./mavlink_msg_geotag_count.h"
#include "./mavlink_msg_geotag_clear_all.h"
#include "./mavlink_msg_geotag_ack.h"
#include "./mavlink_msg_geotag_cancel.h"
#include "./mavlink_msg_wind_sensor.h"
#include "./mavlink_msg_pf_check.h"
#include "./mavlink_msg_wp_arming_check.h"
#include "./mavlink_msg_pfc_ack.h"
