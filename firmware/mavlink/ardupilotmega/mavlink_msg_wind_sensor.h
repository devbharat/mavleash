...
#define MAVLINK_MSG_ID_WIND_SENSOR 202

MAVPACKED(
typedef struct __mavlink_wind_sensor_t {
 float direction; /*<  Wind Direction*/
 float avg_mag; /*<  Average wind measrued*/
 float max_mag; /*<  Maximum wind measured*/
 float std_dev; /*<  Standart Deviation of measured wind magnitude*/
...
#define MAVLINK_MSG_ID_202_CRC 173
 ...
 * @param avg_mag  Average wind measrued
 * @param max_mag  Maximum wind measured
 * @param std_dev  Standart Deviation of measured wind magnitude
 ...
 *
 * @return  Standart Deviation of measured wind magnitude
 */
