...
#define MAVLINK_MSG_ID_GEOTAG_COUNT_LEN 4
#define MAVLINK_MSG_ID_GEOTAG_COUNT_MIN_LEN 4
#define MAVLINK_MSG_ID_208_LEN 4
#define MAVLINK_MSG_ID_208_MIN_LEN 4

#define MAVLINK_MSG_ID_GEOTAG_COUNT_CRC 142
#define MAVLINK_MSG_ID_208_CRC 142
...
#define MAVLINK_MESSAGE_INFO_GEOTAG_COUNT { \
    ...
    {  { "count", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_geotag_count_t, count) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 2, offsetof(mavlink_geotag_count_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 3, offsetof(mavlink_geotag_count_t, target_component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_GEOTAG_COUNT { \
...
{
    return mavlink_msg_geotag_count_pack(system_id, component_id, msg, geotag_count->target_system, geotag_count->target_component, geotag_count->count);
}
...
{
    return mavlink_msg_geotag_count_pack_chan(system_id, component_id, chan, msg, geotag_count->target_system, geotag_count->target_component, geotag_count->count);
}
...
static inline void mavlink_msg_geotag_count_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GEOTAG_COUNT_LEN];
    _mav_put_uint16_t(buf, 0, count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_geotag_count_send(chan, geotag_count->target_system, geotag_count->target_component, geotag_count->count);
#else
 ...
 */
static inline void mavlink_msg_geotag_count_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t count)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
