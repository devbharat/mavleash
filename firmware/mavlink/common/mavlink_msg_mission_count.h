...
typedef struct __mavlink_mission_count_t {
 ...
 int16_t project_hash; /*< Wingtra: Project Hash associated with the mission*/
 uint8_t target_system; /*< System ID*/
 uint8_t target_component; /*< Component ID*/
}) mavlink_mission_count_t;

#define MAVLINK_MSG_ID_MISSION_COUNT_LEN 6
#define MAVLINK_MSG_ID_MISSION_COUNT_MIN_LEN 6
#define MAVLINK_MSG_ID_44_LEN 6
#define MAVLINK_MSG_ID_44_MIN_LEN 6

#define MAVLINK_MSG_ID_MISSION_COUNT_CRC 205
#define MAVLINK_MSG_ID_44_CRC 205
...
#define MAVLINK_MESSAGE_INFO_MISSION_COUNT { \
    ...
    {  { "count", NULL, MAVLINK_TYPE_UINT16_T, 0, 0, offsetof(mavlink_mission_count_t, count) }, \
         { "project_hash", NULL, MAVLINK_TYPE_INT16_T, 0, 2, offsetof(mavlink_mission_count_t, project_hash) }, \
         { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_mission_count_t, target_system) }, \
         { "target_component", NULL, MAVLINK_TYPE_UINT8_T, 0, 5, offsetof(mavlink_mission_count_t, target_component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MISSION_COUNT { \
 ...
 * @param project_hash Wingtra: Project Hash associated with the mission
...
{
    return mavlink_msg_mission_count_pack(system_id, component_id, msg, mission_count->target_system, mission_count->target_component, mission_count->count, mission_count->project_hash);
}
...
{
    return mavlink_msg_mission_count_pack_chan(system_id, component_id, chan, msg, mission_count->target_system, mission_count->target_component, mission_count->count, mission_count->project_hash);
}
...
static inline void mavlink_msg_mission_count_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t count, int16_t project_hash)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MISSION_COUNT_LEN];
    _mav_put_uint16_t(buf, 0, count);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mission_count_send(chan, mission_count->target_system, mission_count->target_component, mission_count->count, mission_count->project_hash);
#else
 ...
 */
static inline void mavlink_msg_mission_count_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t count, int16_t project_hash)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field project_hash from mission_count message
 *
 * @return Wingtra: Project Hash associated with the mission
 */
static inline int16_t mavlink_msg_mission_count_get_project_hash(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_mission_count_decode(const mavlink_message_t* msg, mavlink_mission_count_t* mission_count)
{
    ...
    mission_count->project_hash = mavlink_msg_mission_count_get_project_hash(msg);
